...
(function() {
	...
	Mistify.prototype.appendMasks = function() {
		...
		var maskDom = '' +
			'<div class="mistify__mask-container">' +
				'<div class="mistify__mask mistify__mask--active"><img src="images/slider/mistCarousel-1.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/slider/mistCarousel-2.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/slider/mistCarousel-3.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/slider/mistCarousel-4.png" alt="Mask"/></div>' +
			'</div>';
	...
	Mistify.prototype.preloadMasks = function() {
		...
		var masks = ['/mistcarousel/images/slider/mistCarousel-1.png', '/mistcarousel/images/slider/mistCarousel-2.png', '/mistcarousel/images/slider/mistCarousel-3.png', '/mistcarousel/images/slider/mistCarousel-4.png'];
